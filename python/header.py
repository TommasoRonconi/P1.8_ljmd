...
#dynamic libraries
mpi_dso = CDLL("../Obj-parallel/libLJMD-mpi-LJ.so")
dso = CDLL("../Obj-serial/libLJMD-LJ.so")
omp_dso = CDLL("../Obj-parallel/libLJMD-omp-LJ.so")
momp = CDLL("../Obj-parallel/libLJMD-mpi-omp-LJ.so")
